...
# Step 1: Menentukan 5 kategori produk teratas berdasarkan penjualan
top_categories = merged_data.groupby('product_category_name')['price'].sum().nlargest(5).index

# Step 2: Menentukan 5 lokasi pelanggan teratas berdasarkan penjualan
top_locations = merged_data.groupby('customer_city')['price'].sum().nlargest(5).index

# Step 3: Memfilter merged_data untuk kategori dan lokasi teratas
...
# Step 4: Mengelompokkan data berdasarkan lokasi pelanggan dan kategori produk untuk visualisasi
